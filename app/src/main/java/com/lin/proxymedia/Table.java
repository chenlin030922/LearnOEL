...
public class Table {
    ...
    public void bindData(TextureShaderProgram textureShaderProgram) {
        ...
        vertexArray.setVertexAttribPointer(0,
                textureShaderProgram.getPositionAttributeLocation(), POSITION_COMPONENT_COUNT, STRIDE);
        vertexArray.setVertexAttribPointer(POSITION_COMPONENT_COUNT,
                textureShaderProgram.getaTextureCoordinateLocation(), TEXTURE_COORDINATES_COMPONENT_COUNT, STRIDE);
    }
